def unique_houses(filename):
    ...
    # houses = set()#Only needed if using for loop. Not needed for set comprehension
    house_data = open(filename)

    # for house in house_data:
    #     # house_list = house.split('|')
    #     # houses.add(house_list[2])
    #     houses.add(house.split('|')[2])#Factored down to even shorter of line 20 and 21
    
    #For house in house_data, split where '|' exists in each line of house file and stores strings in a list.
    #Takes the third element of new list and adds it to set.
    houses = {house.split('|')[2] for house in house_data}

    filename.close()#Must be above the return
